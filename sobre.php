		...
		<div class="container">
			...
			<div class="about-text">
				...
				<div class="col-md-6 about-text-right">
					<h4>INFCOLETA: gerando sustentabilidade a Charqueadas</h4>
					<p> O InfColeta é um projeto desenvolvido pela aluna  Gabriella Selbach  no Instituto Federal de Educação, Ciência e Tecnologia Sul-Rio-Grandense - Campus Charqueadas durante o 1ª Edição da CharCode. Tem como objetivo:
