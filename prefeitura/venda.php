<?php
	...
	include('../class/Material.class.php');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
		...
		<div class="container">
			...
			<div class="top-nav">
				...
				<ul>
					...
					<li><a class="active" href="venda.php">Vender</a></li>					
	...
	<div class="account">
		<div class="container">		
			<div>
				<h1>CADASTRAR VENDA DE MATERIAIS</h1>
				<div class="registration_form">
					<form action="" method="POST">
						<div>
							<?php
								$mate= New Material();
								$mate->selectMaterial($mysqli);
							?>
						</div>
						<div>
							<label>
								<input placeholder="Quantidade" type="text" required >
							</label>
						</div>
						<div>
							<label>
								<input placeholder="Valor" type="text" required >
							</label>
						</div>
						<div>
							<input type="submit" value="Cadastrar Venda" id="register-submit">
						</div>	
					<div class="clearfix"> </div>
					<div class="clearfix"> </div>
					<div class="clearfix"> </div>
