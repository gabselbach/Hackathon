		...
		<div class="container">
			...
			<div class="top-nav">
				...
				<ul>
					...
					<li><a class="active"  href="cadastra_posto_coleta.php">Coleta</a></li>
			...
			<div>
				...
				<div class="registration_form">
					<form action="" method="POST">
						...
						<div>
							<label>
								<input placeholder="Cota Disponível" type="text" required >
							</label>
						</div>
						<div>
							<input type="submit" value="Cadastrar Local" id="register-submit">
						</div>
						<div class="clearfix"> </div>
						<div class="clearfix"> </div>
						<div class="clearfix"> </div>
				...
				<h1>PONTOS DE COLETA / EDITAR INFORMAÇÕES </h1>
