		...
		<div class="container">
			...
			<div class="top-nav">
				...
				<ul>
					...
					<li><a class="active" href="cadastra_enquete.php">Enquete</a></li>
	...
	<div class="account">
		<div class="container">		
			<div class="account-left">
				<h1>CADASTRAR NOVA ENQUETE</h1>
				<div class="registration_form">
					<form action="" method="POST">
						<div>
							<label>
								<input placeholder="Opção" type="text" required >
							</label>
						</div>
						<div>
							<input type="submit" value="Cadastrar opção" id="register-submit">
						</div>
						<div class="clearfix"> </div>
						<div class="clearfix"> </div>
						<div class="clearfix"> </div>
